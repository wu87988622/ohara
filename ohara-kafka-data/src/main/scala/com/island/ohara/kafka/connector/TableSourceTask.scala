...
/**
  * A wrap to SourceTask. The users should substitute TableRecord for SourceRecord.
  */
abstract class TableSourceTask extends SourceTask {

  /**
    * Poll this SourceTask for new records. This method should block if no data is currently available.
    *
    * @return a array of TableRecord
    */
  protected def _poll(): Array[TableSourceRecord]
