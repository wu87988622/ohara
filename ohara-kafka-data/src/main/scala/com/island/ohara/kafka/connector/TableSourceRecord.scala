...
/**
  ...
  */
class TableSourceRecord(sourcePartition: Map[String, _], sourceOffset: Map[String, _], topic: String, partition: Int,
  ...
  def this(sourcePartition: Map[String, _], sourceOffset: Map[String, _],
           topic: String, keySchema: Schema, key: Any, table: Table) {
    this(sourcePartition, sourceOffset, topic, -1, keySchema, key, table, -1)
  }

  def this(sourcePartition: Map[String, _], sourceOffset: Map[String, _],
           topic: String, partition: Int, keySchema: Schema, key: Any, table: Table) {
