...
the version of ohara configurator you are running is 0.4.0, then the official images you should download is oharastream/xx:0.4.0.
...
{
  "name": "bk00",
  "imageName": "oharastream/broker:0.4.0",
