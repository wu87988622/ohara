...
Except for clientPort and server.n (see [Zookeeper APIs](rest_interface.md#zookeeper)), other options are auto-generated by
Ohara Configurator and them all are the default value recommended by zookeeper. Feel free to file a issue to Ohara community if
you have better configs for zookeeper.
