...
/**
 * this is a general object storing the java bean object. It consists of "domain", "properties" and "attributes".
 * the domain and properties are a part of {@link ObjectName}
 * the attributes are the collection of value from a bean object. For example, An attributes generated by a bean object having two methods -
 * 1) getValue and 2) getKey - has two key - Key and Value.
 */
public class BeanObject {
  ...
  private BeanObject(String domainName, Map<String, String> properties, Map<String, Object> attributes) {
