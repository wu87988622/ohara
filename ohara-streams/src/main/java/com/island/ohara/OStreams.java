...
public class OStreams<K, V> {
    ...
    private org.apache.kafka.streams.StreamsBuilder builder = new org.apache.kafka.streams.StreamsBuilder();
    ...
    public Topology construct() {
        kstreams.to(this.buildProps.targetTopic, org.apache.kafka.streams.kstream.Produced.with(this.buildProps.keyType, this.buildProps.valueType));
        ...
        org.apache.kafka.streams.StreamsConfig config = new org.apache.kafka.streams.StreamsConfig(props);
