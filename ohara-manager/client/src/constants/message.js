export const LOGIN_SUCCESS = '登入成功！';
export const LOGOUT_SUCCESS = '登出成功！';

export const EMPTY_COLUMN_NAME_ERROR = 'Column Name 是必填欄位！';
export const EMPTY_SCHEMA_NAME_ERROR = 'Schema name 是必填欄位！';
