...
// simulate a promise request with delay 2s
...
// simulate a promise request with delay 1s
export const remove = (): Observable<BasicResponse> =>
  of({
    status: 200,
    title: 'mock delete data',
    data: {},
  }).pipe(delay(1000));

// simulate a promise request with delay 500ms
...
// simulate a promise request with delay 100ms
...
// simulate a promise request with delay 10ms
