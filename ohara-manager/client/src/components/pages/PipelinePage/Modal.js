          ...
          <td>
            <Box>
              <tr>
                ...
                <DeleteIcon
                  onClick={e =>
                    handleDeleteConnection(e, connectionUuid, connectionName)
                  }
                >
              ...
              <ul>
                {connections.map(({ uuid, name }) => {
                  return (
                    <Li key={uuid} onClick={e => setModalField(e, uuid)}>
                      {name}
                    </Li>
                  );
                })}
...
Modal.propTypes = {
  ...
  connectionUuid: PropTypes.string,
