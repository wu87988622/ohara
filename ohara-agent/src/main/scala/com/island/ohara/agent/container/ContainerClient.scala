...
package com.island.ohara.agent.container

import java.util.Objects

import com.island.ohara.agent.container.ContainerClient.ContainerCreator
...
object ContainerClient {
  trait ContainerCreator extends com.island.ohara.common.pattern.Creator[Future[Unit]] {
